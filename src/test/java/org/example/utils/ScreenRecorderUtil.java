...
public class ScreenRecorderUtil extends ScreenRecorder {
    ...
    protected File createMovieFile(Format fileFormat) throws IOException {
        ...
        return new File(movieFolder,
                name.replaceAll(" ", "-") + "-" + sdf.format(new Date()) + "." + Registry.getInstance().getExtension(fileFormat));
    }

    public static void startRecording(String methodName) throws Exception {
        File file = new File(System.getProperty("user.dir") + "/src/test/resources/recording/");
